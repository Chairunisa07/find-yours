  ...
  return (
    <section className="container mx-auto flex flex-col items-center">
      <div className="grid grid-cols-2 justify-center items-center">
        <div className="teks">
          <h1>
            Find The Perfect Job For You in <strong>Find Yours</strong>
          </h1>
          <p className="desc">
            Explore thousands of jobs in one place and find your dream job.
          </p>
          <Button className="button mt-4" onClick={scrollToElement}>
            Get Started
          </Button>
        </div>
        <div className="flex justify-center items-center">
          <img src={Gambar} className="max-w-full h-auto" alt="Gambar" />
        </div>
      </div>

      <div className="grid grid-cols-3 gap-3 justify-center items-center">
        <div id="data-content" className="col text-center">
          <div id="box-data">
            <h2 className="teks-h2">
              <strong>1500+</strong>
            </h2>
          </div>
          <div id="data-text">
            <h3 className="text-center">Registered Job Seekers</h3>
          </div>
        </div>
        <div id="data-content" className="col text-center">
          <div id="box-data">
          ...
          <div id="data-text">
            <h3 className="text-center">Searchable Job</h3>
          </div>
        </div>
        <div id="data-content" className="col text-center">
          <div id="box-data">
          ...
          <div id="data-text">
            <h3 className="text-center">Registered Employers</h3>
          </div>
        </div>
      </div>
      ...
      <div
        id="find-job"
        className="grid grid-cols justify-center items-center mt-4"
      >
        <h2 className="teks-h2">
      ...
      <div className="job-container justify-center items-center mt-4">
        {jobData.map((job) => (
      ...
      <div
        id="contact"
        className="contact-container mt-4 mb-4 max-w-screen-lg mx-auto"
      >
